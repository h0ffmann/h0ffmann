...
| [present](https://github.com/h0ffmann/nix-config/tree/main/labs/present) | annotate, capture and record the screen; webcam profiles (cam); pdfpc, presenterm | `6774f7b` | 2026-09-22 (hoje) | gromit-mpx 1.9.0 · obs-studio 32.2.2 · v4l-utils 1.32.0 · presenterm 0.16.1 |
